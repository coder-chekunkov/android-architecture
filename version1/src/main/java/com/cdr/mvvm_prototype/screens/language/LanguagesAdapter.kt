...
import com.cdr.mvvm_prototype.databinding.ItemLanguageBinding
...
class LanguagesAdapter(private val languageActionListener: LanguageActionListener) :
    ...
    var data: List<Language> = emptyList()
        set(newValue) {
            ...
            field = newValue
            diffUtilResult.dispatchUpdatesTo(this@LanguagesAdapter)
        }
