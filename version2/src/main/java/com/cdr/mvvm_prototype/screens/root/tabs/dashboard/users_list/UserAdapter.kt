...
import com.cdr.version2.databinding.ItemUserBinding
...
class UsersAdapter(private val userActionListener: UserActionListener) :
    ...
    override fun onBindViewHolder(holder: UsersViewHolder, position: Int) {
        ...
        with(holder.binding) {
            ...
            Glide.with(context).load(user.photo).circleCrop().error(R.drawable.ic_user_photo)
                .placeholder(R.drawable.ic_user_photo).into(imageView)
